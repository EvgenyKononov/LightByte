  ...
  return (
    <div>
      ...
      <div className={block}>
        ...
        {/*<div className={`${block}__section`}>*/}
        {/*  <h2>What is LightBite?</h2>*/}
        {/*  <div className={`${block}__divider`}></div>*/}
        {/*  <p>*/}
        {/*    LightBite is an initiative aimed at helping small and local*/}
        ...
        {/*    <br/><br/>*/}
        {/*    LightBite is a free service and not a company/business.*/}
        {/*  </p>*/}
        {/*</div>*/}
        ...
        {/*  <div className={`${block}__divider`}></div>*/}
        {/*  <p>*/}
        {/*    There are many services that are similar to LightBite but they all*/}
        ...
        {/*    making LightBite free, we're also encouraging business owners to*/}
        ...
        {/*<div className={`${block}__section`}>*/}
        {/*  <h2>How does LightBite make money?</h2>*/}
        {/*  <div className={`${block}__divider`}></div>*/}
        {/*  <p>*/}
        {/*    LightBite doesn't make money and we don't have plans to monetize it.*/}
        {/*    It's our way of contributing and offering help to the small*/}
        {/*    businesses that have been struggling this year. Managing and*/}
        {/*    maintaining LightBite requires minimal costs that we cover*/}
        {/*    ourselves.*/}
        {/*  </p>*/}
        {/*</div>*/}
      </div>
